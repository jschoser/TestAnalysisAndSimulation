...
for k in range(9):
    ...
    ax.bar(wd, ws, nsector=8, bins=np.arange(0, 0.105, 0.015), cmap=cm.OrRd, opening=0.85, edgecolor='white')
    ax.set_yticks(np.arange(4, 12, step=4))
    ax.set_yticklabels(np.arange(4, 12, step=4))
